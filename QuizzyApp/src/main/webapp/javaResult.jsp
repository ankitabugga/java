...
<head>
    ...
    <script>
        function handleMediumQuiz(score) {
            if (score > 5) {
                window.location.href = "javaMedium.jsp";
            } else {
                alert("Your score is too low (" + score + "/10). Please repeat the Basic java Quiz before proceeding.");
            }
        }
    </script>
</head>
