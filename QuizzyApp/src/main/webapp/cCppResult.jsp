...
<head>
    ...
    <script>
        function handleMediumQuiz(score) {
            if (score > 5) {
                window.location.href = "CMedium.jsp";
            } else {
                alert("Your score is too low (" + score + "/10). Please repeat the Basic C and C++ Quiz before proceeding.");
            }
        }
    </script>
</head>
...
<div class="container text-center">
    <div class="result-box">
        <h2 class="mb-4">Your Basic C and C++ Quiz Score</h2> 
